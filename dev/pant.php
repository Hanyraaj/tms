<?php
  ...
  include('config.php');  
      ...
      $c_waist  = $_POST['c_waist'] ;
      $c_length  = $_POST['c_length'] ;
      $c_hight  = $_POST['c_hight'] ;
      $c_open = $_POST['c_open'] ;
      $c_under  = $_POST['c_under'] ;     
      $c_back_pocket = $_POST['c_back_pocket'] ;
    $sqlx = "INSERT INTO pant (c_name,c_email,c_contact,c_address,c_waist,c_length,c_hight,c_open,c_under, c_back_pocket) VALUES ('$c_name','$c_email','$c_contact','$c_address','$c_waist','$c_length','$c_hight','$c_open','$c_under ','$c_back_pocket')";
     ...
     // $sqlx = "INSERT INTO frock (a1,a2,a3,a4,a5,a6,a7,a8,a9) VALUES ('$a1','$a2','$a3','$a4','$a5','$a6','$a7','$a8','$a9')";
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-7 col-sm-12 col-form">
                            <h4 class="title-style-2">Jeans Pant Measurement Details</h4>
                            <hr>
                            <form action="pant.php" method="POST">
                                <div class="row" style="margin-top: 15px">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="text">Waist</label>
                                        <input type="text" name="c_waist" class="form-control" placeholder="Your waist">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="text">Length</label>
                                        <input type="text" name="c_length" class="form-control" placeholder="Your length">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="text">Hight</label>
                                        <input type="text" name="c_hight" class="form-control" placeholder="Your hight">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="text">Open</label>
                                        <input type="text" name="c_open" class="form-control" placeholder="Your open">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="text">Under</label>
                                        <input type="text" name="c_under" class="form-control" placeholder="Your under">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="number">Back Pocket</label>
                                        <select name="c_back_pocket" class="form-control">
