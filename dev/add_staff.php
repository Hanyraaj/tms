<?php
    ...
    include('config.php');  
        ...
        $sqlx = "INSERT INTO staff (c_name,c_email,c_contact,c_address,c_salary,c_position) VALUES ('$c_name','$c_email','$c_contact','$c_address','$c_salary','$c_position')";
          try{
  ...
  ?>
    ...
    <head>
        ...
        <!-- Font Awesome -->
        <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.1.1/css/all.css" integrity="shc_contact84-O8whS3fhG2Onc_salaryKas0Y9l3cfpmYjapjI0E4theH4iuMD+pLhbf6JI0jIMfYcK3yZ" crossorigin="anonymous">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-7 col-sm-12 col-form">
                            <h4 class="title-style-2">Add new staff Details</h4>
                            <hr>
                            <form action="add_staff.php" method="POST">
                                <div class="row" style="margin-top: 15px">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" name="c_salary" class="form-control" placeholder="10000">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="text">Position</label>
                                        <input type="text" name="c_position" class="form-control" placeholder="Asistent">
                                    </div>
                                </div>
