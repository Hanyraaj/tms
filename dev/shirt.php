<?php
  ...
  include('config.php');  
      ...
      $c_higth  = $_POST['c_higth'] ;
      $c_weigth = $_POST['c_weigth'] ;
      $c_shoulder  = $_POST['c_shoulder'] ;
      $c_half_chest  = $_POST['c_half_chest'] ;
      $c_halp_weight  = $_POST['c_halp_weight'] ;     
      $c_sleeve = $_POST['c_sleeve'] ;
      $c_chest_pocket = $_POST['c_chest_pocket'] ;
      $a12 = $_POST['a12'] ;

  
      
    $sqlx = "INSERT INTO shirt (c_name,c_email,c_contact,c_address,c_higth,c_weigth,c_shoulder,c_half_chest,c_halp_weight,c_sleeve,c_chest_pocket,a12) VALUES ('$c_name','$c_email','$c_contact','$c_address','$c_higth','$c_weigth','$c_shoulder','$c_half_chest','$c_halp_weight','$c_sleeve','$c_chest_pocket','$a12')";
        try{
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-7 col-sm-12 col-form">
                            <h4 class="title-style-2">Jeans Shirt Measurement Details</h4>
                            <hr>
                            <form action="shirt.php" method="POST">
                                <div class="row" style="margin-top: 15px">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" name="c_email" class="form-control" placeholder="johndoe@mail.com">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="text">Hight</label>
                                        <input type="text" name="c_higth" class="form-control" placeholder="Your Hight">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="text">Weight</label>
                                        <input type="text" name="c_weigth" class="form-control" placeholder="Your Weight">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="text">Shoulder</label>
                                        <input type="text" name="c_shoulder" class="form-control" placeholder="Your Shoulder">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="text">Half chest</label>
                                        <input type="text" name="c_half_chest" class="form-control" placeholder="Your Half chest">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="text">half waist</label>
                                        <input type="text" name="c_halp_weight" class="form-control" placeholder="Your half waist">
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label for="text">Sleeve</label>
                                        <input type="text" name="c_sleeve" class="form-control" placeholder="Your Sleeve">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="text">Chest Pocket</label>
                                        <select name="c_chest_pocket" class="form-control">
