<?php
  ...
  include('config.php');  
    $c_name  = $_POST['c_name'] ;
      ...
      $c_body_length  = $_POST['c_body_length'] ;
      $c_shoulder  = $_POST['c_shoulder'] ;
      $c_chest  = $_POST['c_chest'] ;
      $c_waist  = $_POST['c_waist'] ;
 
    $sqlx = "INSERT INTO kameez (c_name, c_email, c_contact, c_address, c_body_length, c_shoulder, c_chest, c_waist ) VALUES ('$c_name ','$c_email','$c_contact','$c_address','$c_body_length','$c_shoulder','$c_chest','$c_waist')";
        try{
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-7 col-sm-12 col-form">
                            <h4 class="title-style-2">Ladies Kameez Measurement Details</h4>
                            <hr>
                            <form action="kameez.php" method="POST">
                                <div class="row" style="margin-top: 15px">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="text">Body Length</label>
                                        <input type="text" name="c_body_length" class="form-control" placeholder="Your body length">
                                    </div>
                                    <div class="form-group col-md-6">
