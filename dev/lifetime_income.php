...
?>
    ...
    <body>
        ...
        <div class="line-chart" style="width: 75%; margin: 8% 0% 5% 20%;">
            <canvas id="line-chart-yearly" width="1600" height="500"></canvas>
        </div>
        <!-- End Lifetime Income Chart -->
        ...
        <script>
            /* Loop through all dropdown buttons to toggle between hiding and showing its dropdown content - This allows the user to have multiple dropdowns without any conflict */
              ...
              new Chart(document.getElementById("line-chart-yearly"), {
                  type: 'line',
                  data: {
                      labels: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026, 2026, 2027, 2028],
                      datasets: [{
